...
import { useParams } from "next/navigation"; // นำเข้า useParams เพื่อดึงค่า lang จาก URL
...
export default function LoginPage() {
  // ดึงค่า lang จาก URL (เช่น 'th' หรือ 'en')
  const params = useParams();
  const lang = params.lang as string;

  // เลือก Dictionary ให้ตรงกับภาษา
  const dict = lang === "th" ? thDict : enDict;

  return (
    <div className="min-h-screen flex bg-white text-neutral-900 font-sans selection:bg-neutral-900 selection:text-white">
      ...
      <div className="w-full lg:w-1/2 flex flex-col p-6 sm:p-12 md:p-16 lg:p-20">
        {/* ปุ่มกลับหน้าแรก (อัปเดต href ให้จำภาษาไว้) */}
        ...
        {/* ฟุตเตอร์เล็กๆ ด้านล่างสุดของฟอร์ม */}
