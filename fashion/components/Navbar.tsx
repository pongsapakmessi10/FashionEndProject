      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            <a href={`/${lang}#how-it-works`} className="text-sm font-medium hover:text-neutral-500 transition-colors">
              {dict.nav.howItWorks}
            </a>
            <a href={`/${lang}#trending`} className="text-sm font-medium hover:text-neutral-500 transition-colors">
              {dict.nav.trending}
            </a>
            
            <div className="flex items-center gap-5 ml-2">
              <LanguageSwitcher />
              <Link href={`/${lang}/login`} className="bg-black text-white px-6 py-2.5 rounded-full text-sm font-medium hover:bg-neutral-800 transition-all">
                {dict.nav.signIn}
              </Link>
            </div>
          </div>
